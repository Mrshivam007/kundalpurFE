...
import { CustomTableInput } from '../../../../RequirementsRaise/Suppliers/components/common';


const ViewItem = ({ updatedata, openEdit, closeEdit, handleApprove }) => {
                        ...
                        <div>
                            <form >
                                ...
                                <div className="add-div-close-div">
                                    ...
                                    <h2 clssName="add_text_only">Purchase Requisition Data</h2>
                                ...
                                <div className="save-div-btn" style={{ marginTop: '5%' }}>
                                    <button className="save-div-btn-btn"
                                        ...
                                        onClick={() => { handleApprove(updatedata); closeEdit(); }}
                                        >
                                        Approve Request
                                    </button>
                                    <button
