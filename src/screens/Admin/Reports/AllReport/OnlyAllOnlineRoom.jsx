...
const OnlyAllOnlineRoom = ({ setopendashboard }) => {
  ...
  const getall_donation = () => {
    setloader(true);
    serverInstance(`room/consolidatedForOnlineRoom`, 'POST', {
      fromDate: fromdate,
      toDate: toDate,
    }).then((res) => {
      console.log(res);
  ...
  const ExportToExcel = () => {
    const fileName = 'Online Consolidated';
  ...
  useEffect(() => {
    var filtered = isDataDummy?.filter(
      (dt) =>
        ...
        dt?.employeeName?.toLowerCase().indexOf(customername) > -1,
    );
        ...
        >
          ...
          >
            ...
            <Tooltip title="Export Pdf File">
              <IconButton>
                <img
                  onClick={() => ExportPdfmanul(isData, 'Online Consolidated')}
                  src={ExportPdf}
                  alt="cc"
                  style={{ width: '30px' }}
                />
            ...
            <TableHead style={{ background: '#F1F0F0' }}>
              <TableRow>
                ...
                <TableCell>
                  ...
                  <i
                    style={{ marginLeft: '0.5rem' }}
                    onClick={() => sortData('onlineCheckinAmount')}
                    class={`fa fa-sort`}
                  />
                </TableCell>
                {/* <TableCell>
                ...
                <TableCell>
                  ...
                  <i
                    style={{ marginLeft: '0.5rem' }}
                    onClick={() => sortData('totalRoomAmount')}
                    class={`fa fa-sort`}
                  />
                </TableCell>
                <TableCell>
                  ...
                  <i
                    style={{ marginLeft: '0.5rem' }}
                    onClick={() => sortData('totalRemainingAmount')}
                    class={`fa fa-sort`}
                  />
                </TableCell>
                <TableCell>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>
                  <input
                    ...
                    type="text"
                    onChange={(e) =>
                      onSearchByOther(e, 'onlineCheckinAmount')
                    }
                ...
                <TableCell>
                  <input
                    ...
                    className="cuolms_search"
                    type="text"
                    onChange={(e) => onSearchByOther(e, 'totalRoomAmount')}
                ...
                <TableCell>
                  <input
                    ...
                    className="cuolms_search"
                    type="text"
                    onChange={(e) => onSearchByOther(e, 'totalRemainingAmount')}
                ...
                <>
                  {(rowsPerPage > 0
                    ...
                    >
                      ...
                      <TableCell>{row?.onlineCheckinAmount}</TableCell>
                      <TableCell>{row?.totalRoomAmount}</TableCell>
                      <TableCell>{row?.totalAdvanceAmount}</TableCell>
                      <TableCell>{row?.totalRemainingAmount}</TableCell>
                    </TableRow>
                  ))}
                </>
              ) : (
              ...
              <TableRow>
                ...
                <TableCell style={{ fontWeight: 800 }}>
                  {isData &&
                    isData?.reduce(
                      (n, { onlineCheckinAmount }) =>
                        parseFloat(n) + parseFloat(onlineCheckinAmount),
                      0,
                    )}
                </TableCell>
                <TableCell style={{ fontWeight: 800 }}>
                  {isData &&
                    isData.reduce(
                      (n, { totalRoomAmount }) =>
                        n + (parseFloat(totalRoomAmount) || 0), // Convert to number or default to 0
                      0
                    )}
                </TableCell>
                ...
                <TableCell style={{ fontWeight: 800 }}>
                  {isData &&
                    isData.reduce(
                      (n, { totalAdvanceAmount }) =>
                        n + (parseFloat(totalAdvanceAmount) || 0), // Convert to number or default to 0
                      0
                    )}
                </TableCell>
                <TableCell style={{ fontWeight: 800 }}>
                  {isData &&
                    isData.reduce(
                      (n, { totalRemainingAmount }) =>
                        n + (parseFloat(totalRemainingAmount) || 0), // Convert to number or default to 0
                      0
                    )}
                </TableCell>
                <TableCell></TableCell>
...
export default OnlyAllOnlineRoom;
