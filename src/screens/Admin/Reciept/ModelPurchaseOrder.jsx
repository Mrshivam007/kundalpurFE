...
const ModalPurchaseOrder = ({
    ...
    console.log("getting data on modal ", isData);
                ...
                >
                    ...
                    <div className="reciptimg">
                        {isData?.LedgerNo ? (
                            ...
                            <>
                                <div className="reciptbody">
                                    <div className="leftdata">
                                        <span className="leftitems">
                                            <h2>परचेस ऑर्डर रसीद नं : </h2>
                                            <h2 className="font_bold_in_donation">
                                                &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                                {isData?.purchaseOrderNo
                                                    ? isData?.purchaseOrderNo
                                                    : isData?.ReceiptNo}
                                            </h2>
                                        </span>
                        ...
                        <span className="rightitems2 ">
                            ...
                            >
                                <h2>डिपार्टमेंट का नाम :</h2>
                            </div>
                            <h2 className="font_bold_in_donation">
                                &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
                                {isData?.departmentName
                                    ? isData?.departmentName
                                    : isData?.ReceiptNo}
                            </h2>
                        </span>
                        <span className="rightitems2" style={{ lineHeight: '8px' }}>
                            <div className="dan_ka_mad">
                                <h2>आइटम का नाम:</h2>
                            </div>
                            <span className="center_receipt_format">
                                {isData && isData.purchaseOrderList && (
                                    <>
                                        <h2>
                                            &nbsp; &nbsp; &nbsp;
                                            <b>
                                                {isData.purchaseOrderList
                        ...
                        <span className="rightitems2" style={{ lineHeight: '24px' }}>
                            <div className="dan_ka_mad">
                                <h2>माप की इकाई UOM:</h2>
                            </div>
                            <span className="center_receipt_format">
                                {isData && isData.purchaseOrderList && (
                                    <>
